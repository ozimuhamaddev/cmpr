...
<div class="modal-body">
  ...
  <form id="formInput" class="row g-3">
    ...
    <div class="col-md-12">
      ...
      <input type="text" name="category" class="form-control" value="{{$news->data->getDetail->category_name}}" required>
    </div>
    <div class="col-md-12">
      <label for="formFile" class="form-label">Tags</label>
      <input type="text" name="tags" class="form-control" value="{{$news->data->getDetail->tag}}" required>
    </div>
    <div class="col-md-12">
